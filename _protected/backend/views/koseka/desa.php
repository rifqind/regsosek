...
Url::remember(['koseka/desa', 'id' => $data[0]['id_kec']], 'desa');

$t = NULL;
$r_c = NULL;
$r_e = NULL;
foreach ($data as $key => $value) {
    $labels[] = $value['id_desa'];
    ...
    <div class="body-content">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <?php echo Html::a( 'Kembali', Url::previous('kec'), ['class'=>'btn btn-secondary text-white']);?>
                        <?php $gridColumns = [
                        ...
                        'contentOptions' => ['style' => ['text-align' => 'center']],
                         'header' => '<b>No.</b>',
                                ...
                                'attribute' => 'id_desa',
                                'header' => '<b>Kode</b>',
                                'footer' => $data[0]['id_kec'],
                                ],
                                [
                                'attribute' => 'nama_desa',
                                'header' => '<b>Desa/Kelurahan</b>',
                                'contentOptions' => ['style' => ['text-align' => 'left']],
                                'footer' => $data[0]['nama_kec'],
                                'format' => 'raw',
                                   'value' => function ($model) {
                                            $url = Url::to(['koseka/sls', 'id' =>$model['id_desa']]);
                                            $a = Html::a($model['nama_desa'], $url);
