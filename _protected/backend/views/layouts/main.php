...
<head>
    ...
    <style type="text/css">
        ...
        .kv-table-header th:nth-child(1){
            width: 1%;
        }
        .kv-table-header th:nth-child(2){
            width: 6%;
        }
        .kv-table-footer td:nth-child(2){
            text-align: center;
        }
        .kv-table-footer td:nth-child(3){
            text-align: left;
        }
        .kv-table-footer {
            text-align: right;
        ...
        .kv-table-header th:nth-child(3){
            width: 12%;
        }
        .w4 td{
            text-align: right;
